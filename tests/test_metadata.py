...
def test_pyproject_discovery_metadata():
    ...
    assert {"mcp", "security", "static-analysis"} <= set(project["keywords"])
...
def test_action_metadata_stays_checkout_installable():
    ...
    assert 'description: "Set to true to create or update a marked pull request comment on pull_request events."' in action
